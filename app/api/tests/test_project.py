...
async def test_get_project_service_success(mock_get_project_service):
    mock_db = AsyncMock()
...
async def test_update_todo_service_success(mock_update_todo_service):
    mock_db = AsyncMock()
...
async def test_delete_todo_service_success(mock_delete_todo_service):
    mock_db = AsyncMock()
...
async def test_get_todo_items_service_success(mock_get_todo_items_service):
    mock_db = AsyncMock()
...
async def test_reorder_todo_items_service_success(mock_reorder_todo_items_service):
    mock_db = AsyncMock()
...
async def test_add_todo_status_service_success(mock_add_todo_status_service):
    mock_db = AsyncMock()
...
async def test_delete_todo_status_service_success(mock_delete_todo_status_service):
    mock_db = AsyncMock()
...
async def test_assign_todo_service_success(mock_assign_todo_service):
    mock_db = AsyncMock()
